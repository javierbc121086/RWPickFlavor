...
public class PickFlavorViewController: UIViewController, UICollectionViewDelegate {
  ...
  private func loadFlavors() {
    ...
    self.showLoadingHUD()  // <-- Add this line
    
    // 1
    Alamofire.request(.GET, "http://www.raywenderlich.com/downloads/Flavors.plist", parameters: nil, encoding: .PropertyList(.XMLFormat_v1_0, 0), headers: nil)
